...
Помимо прекрасно подходит для создания веб-сайтов, ASP.NET Core MVC имеет отличную поддержку для построения веб-API. Можно создавать службы, могут получить доступ широкого диапазона клиентов, включая браузеры и мобильные устройства.
